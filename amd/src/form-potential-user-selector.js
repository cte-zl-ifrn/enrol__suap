 ...
 *
 * @module     enrol_suap/form-potential-user-selector
...
define(['jquery', 'core/ajax', 'core/templates', 'core/str'], function ($, Ajax, Templates, Str) {
    ...
    return /** @alias module:enrol_suap/form-potential-user-selector */ {
            ...
            promise[0].then(function (results) {
                ...
                if (results.length <= perpage) {
                    ...
                    $.each(results, function (index, user) {
                        ...
                        promises.push(Templates.render('enrol_suap/form-user-selector-suggestion', ctx));
                    });
