...
/**
 * This file processes AJAX enrolment actions and returns JSON for the suap enrolments plugin
 *
...
require_once($CFG->dirroot . '/enrol/suap/classes/enrol_users_form.php');
...
switch ($action) {
    case 'enrol':
        ...
        $mform = new enrol_suap_enrol_users_form(null, (object)["context" => $context]);
        $userenroldata = ['startdate' => $timestart, 'timeend' => $timeend];
